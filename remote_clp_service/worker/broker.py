...
def broker_configuration() -> BrokerConfiguration:
    ...
    status_channel_name = os.environ.get('RABBITMQ_STATUS_CHANNEL', 'rclp-status')
...
def listen_for_tasks():
    ...
    channel.basic_consume(queue=config.jobs_channel_name, on_message_callback=on_job_received)
